...
export default function Dashboard() {
  ...
  <div className="wrap" style={{'paddingTop': '20px'}}>
    <ol className="bc-list" itemscope itemtype="https://schema.org/BreadcrumbList">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <span itemprop="name">My Pet Dashboard</span>
    ...
    <section className="hero" style={{'padding': '60px 0'}}>
      <div className="wrap grid-2">
        <div className="hero-content">
          <div className="hero-tag">Pet Dashboard</div>
          <h1>Your Pet’s <em>Command Center</em>.</h1>
          <p className="lead">Log in to view upcoming vaccination reminders, recent vet visits, active prescriptions, and
            dietary recommendations tailored dynamically to your pet’s age and breed.</p>
          <div className="hero-actions">
            <a href="#" className="btn btn-amber">Applicant Login →</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="section records-section">
      <div className="wrap">
        <div className="section-head" style={{'textAlign': 'center', 'marginBottom': '40px'}}>
          <div className="feature-label">At a Glance</div>
        ...
        <div className="records-grid">
          ...
          <div className="record-item">
            <h4>📅 Timeline</h4>
            <p>A Facebook-style timeline of your pet’s entire medical life.</p>
          </div>
          <div className="record-item">
            <h4>🔔 Smart Alerts</h4>
            <p>Never miss a deworming or vaccination date again.</p>
          </div>
          <div className="record-item">
            <h4>📈 Growth Charts</h4>
            <p>Track puppy/kitten weight against breed-specific averages.</p>
          </div>
          <div className="record-item">
            <h4>💳 E-Pay</h4>
            <p>One-click payments for clinic visits and marketplace orders.</p>
          </div>
        </div>
      </div>
    </section>
