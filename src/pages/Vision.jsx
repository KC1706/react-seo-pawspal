...
export default function Vision() {
  ...
  <div className="wrap" style={{'paddingTop': '20px'}}>
    <ol className="bc-list" itemscope itemtype="https://schema.org/BreadcrumbList">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <span itemprop="name">Vision & Investors</span>
    ...
    <section className="hero" style={{'padding': '60px 0'}}>
      <div className="wrap grid-2">
        <div className="hero-content">
          <div className="hero-tag">Vision & Investors</div>
          <h1>Building the <em>Pet Economy</em>.</h1>
          <p className="lead">PawsPal Connect is standardizing the $5B Indian pet care market. We are building the infrastructure rail connecting 50 million pets, 20k vets, and thousands of brands.</p>
          <div className="hero-actions">
            <a href="#" className="btn btn-amber">Read Deck →</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="section records-section">
      <div className="wrap">
        <div className="section-head" style={{'textAlign': 'center', 'marginBottom': '40px'}}>
          <div className="feature-label">Scalable Infrastructure</div>
          <h2>Our Traction</h2>
        </div>
        ...
        <div className="records-grid">
          ...
          <div className="record-item">
            ...
            <p>India’s pet market is growing at an incredible 25% CAGR.</p>
          </div>
          <div className="record-item">
            <h4>🧩 Fragmented Industry</h4>
            <p>No single digital player currently owns the unified data layer.</p>
          </div>
          <div className="record-item">
            <h4>💡 Network Effect</h4>
            <p>Every vet onboarded brings hundreds of pet owners to the platform.</p>
          </div>
          <div className="record-item">
            <h4>💰 Monetization</h4>
            <p>Multiple streams: SaaS for vets, transactions, and premium AI subs.</p>
          </div>
        </div>
      </div>
    </section>
